...
const RoomDetails = () => {
    ...
    return room && (
        ...
        rounded-full'>20% OFF</p>
            ...
            bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 
            max-w-6xl'>
                ...
                md:gap-10 text-gray-500'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <input type="date" onChange={(e) => setCheckInDate(e.target.value)} min={new Date().toISOString().split('T')[0]}
                            disabled={false} id="checkInDate" placeholder='Check-In'
